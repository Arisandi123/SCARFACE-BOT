...
const daftar2 = '*Created © Scarface Official*'
...
// Wadefak Men
const fmen = { key : { participant : '0@s.whatsapp.net'}, message: {orderMessage: {itemCount : 2021, status: 1, surface : 1, message: `© Scarface Official`, thumbnail: fs.readFileSync('./src/Mufar.jpg'), sellerJid: '0@s.whatsapp.net'}}}
const fdoc = { key: { participant : '0@s.whatsapp.net'}, message: {documentMessage: {title: `© Scarface Official`, jpegThumbnail: thumb}}}
...
const fgif = { key: { participant: '0@s.whatsapp.net', ...(from ? { remoteJid: "6283871990243-1613049930@g.us" } : {})}, message: {"videoMessage": { "title":`© Scarface Official`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `© Scarface Official`, 'jpegThumbnail': thumb}}}
const fgclink = { key: { participant: '0@s.whatsapp.net', "remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6283871990243-1616169743@g.us","inviteCode": "m","groupName": "Scarface Official", "caption": `© Scarface Official`, 'jpegThumbnail': thumb}}}
const fvideo = { key: { fromMe: false, participant: '0@s.whatsapp.net', ...(from ? { remoteJid: "6283871990243-1613049930@g.us" } : {})}, message: { "videoMessage": { "title":`© Scarface Official`, "h": `Hmm`,'seconds': '99999', 'caption': `© Scarface Official`, 'jpegThumbnail': thumb}}}
const floc = { key: { participant : '0@s.whatsapp.net'}, message: {locationMessage: {name: `© Scarface Official`, jpegThumbnail: thumbz}}}
const fakevo = { key: { fromMe: false, participant: '0@s.whatsapp.net', remoteJid: 'status@broadcast'}, message: {imageMessage: {mimetype: 'image/jpeg', caption: 'Scarface Selfbot', jpegThumbnail: fs.readFileSync('./src/Mufar.jpg'), viewOnce: true}}}
...
{ buttonId: `${prefix}owner`, buttonText: { displayText: 'Creator ScarfaceBot' }, type: 1 }
]
menuk =`${tampilUcapan}, ${pushname}
*Mode Type : ${publik ? 'Public' : 'Self'} Bot*

*• About Owner*
Youtube : Scarface Official
No Whatsapp : @${owner}
...
gbutsan = [
{buttonId:`owner`, buttonText:{displayText: 'Creator Scarfacebot'}, type:1},
...
footerText: '*_© Scarface - Official Bot_*',
description: `${tampilUcapan} ${pushname}, *Hallo User @${sender.split('@')[0]}, Silahkan pilih menu Scarface-Bot disini*`,
sections: [
                 {
                 "title": `${week}, ${calender}`,
 rows: [
...
case 'rulesbot':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
ruls =`*Syarat & Ketentuan ScarfaceBot.ೃ🐣*
...
*Silahkan lanjut gunakan Scarface Bot!*`
...
members_ids.push(mem.jid)
            ...
            vcard2 = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + `FN:Scarface Official\n`
            + `ORG:Name YT : Scarface Official;\n`
            + `TEL;type=CELL;type=VOICE;waid=${owner}:${owner}\n`
            + 'END:VCARD'.trim()
            Mufar.sendMessage(from, {displayName: `Name YT : Scarface Official`, vcard: vcard2}, contact, 
            { quoted: fmen, 
            })
            replyWithFakeLink('*Ini Nomor Owner Scarface BOT*\nMau Chat? Utamakan Salam!')
            limitAdd(sender, limit)
            break
...
trans = `Created © Scarface Official`
but = [
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
but = [{ buttonId: `${prefix}owner`, buttonText: { displayText: 'Chat Owner' }, type: 1 }]
sendButton(from, "Scarface bot menjual SC seharga 5K!\n*Atau tunggu Tanggal 1 Desember!*", faketeks, but, mek)
limitAdd(sender, limit)
lbreak
...
*_© Scarface Official_*
*[ SC : Scarface OFFICIAL ]*`
...
const btnsharam = {
contentText: `${mek}`,
footerText: '*_© Scarface Official_*',
buttons: buttons,
headerType: 1
}
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
if (isLimit(sender, isPrem, isOwner, limitawal, limit)) return reply(mess.limit)
if (args.length == 0) return reply(`Example: ${prefix + command} Scarface Official`)
mf4r = args.join(" ")
buffer = await getBuffer(`https://api.lolhuman.xyz/api/tweettrump?apikey=${lolkey}&text=${mf4r}`)
Mufar.sendMessage(from, buffer, image, {quoted: mek, caption: '*© Scarface Official*'})
limitAdd(sender, limit)
break
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
if (isLimit(sender, isPrem, isOwner, limitawal, limit)) return reply(mess.limit)
if (args.length == 0) return reply(`Example: ${prefix + command} Scarfacez`)
xrtz = args.join(" ")
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
if (isLimit(sender, isPrem, isOwner, limitawal, limit)) return reply(mess.limit)
if (args.length == 0) return reply(`Example: ${prefix + command} Scarface`)
mf4r = args.join(" ")
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
if (isLimit(sender, isPrem, isOwner, limitawal, limit)) return reply(mess.limit)
if (args.length == 0) return reply(`Usage: ${prefix + command} query\nExample: ${prefix + command} Scarface Official`)
username = args[0]
comment = args[2]
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
if (isLimit(sender, isPrem, isOwner, limitawal, limit)) return reply(mess.limit)
if (args.length == 0) return reply(`Example: ${prefix + command} Scarface Ganz`)
txt1 = args[0]
txt2 = args[1]
...
const btnbc = {
contentText: `${q}`,
footerText: '*BROADCAST Scarface BOT*',
buttons: buttonss,
headerType: 1
}
...
case 'addrespon':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.owner)
if (args.length < 1) return reply(`Example : ${prefix}addrespon Subs Scarface|Y`)
argz = arg.split('|')
...
case 'delrespon':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.owner)
if (args.length < 1) return reply(`Example : ${prefix}delrespon Subs Scarface`)
